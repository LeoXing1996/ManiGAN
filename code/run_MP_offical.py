...
def parse_args():
    ...
    parser.add_argument('--net_G', type=str,
                        default='../models/offical/bird_Main.pth', help='path for net_G')
    parser.add_argument('--net_C', type=str,
                        default='../models/offical/bird_DCM.pth', help='path for net_C')
...
if __name__ == "__main__":
    ...
    fource_run = args.fource
    save_fig = args.figure

    cfg.TEXT.CAPTIONS_PER_IMAGE = args.cap
