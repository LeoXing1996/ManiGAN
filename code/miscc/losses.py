...
def discriminator_loss(netD, real_imgs, fake_imgs, conditions,
                       ...
                       image_encoder, class_ids, w_words_embs,
    ...
    real_result = word_level_correlation(region_features_real, words_embs,
                                         cap_lens, batch_size,
                                         class_ids, real_labels)

    w_real = word_level_correlation(region_features_real, w_words_embs,
...
def D_loss_dist(D_outputs, real_imgs, words_embs, cap_lens,
                image_encoder, class_ids, w_words_embs,
                wrong_caps_len, wrong_cls_id, real_labels, fake_labels):
    # Forward
    # real_features = netD(real_imgs)
    # fake_features = netD(fake_imgs.detach())
    # # loss
...
def G_loss_dist(D_outputs, image_encoder, fake_imgs,
                words_embs, sent_emb, match_labels,
                cap_lens, class_ids, VGG, real_imgs):
    numDs = len(D_outputs)
